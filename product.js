...
function displayproducts() {
    ...
    <div class="col">
                <div class="position-relative img1">
                    <img src="images2/${items.id}.jpg" class="d-block h-75 w-100" alt="...">
...
function rendercartitems() {
    ...
    cart.forEach((item) => {
        cartitemsel.innerHTML += `
                  ...
                  <tbody>
                    <tr><td><img src="images2/${item.id}.jpg" height=50 width=50></td>
